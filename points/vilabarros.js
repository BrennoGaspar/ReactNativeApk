...
function VilaBarrosScreen({ navigation }) {
  ...
  const savedCoordinates = [
    { latitude: -23.451019340949422, longitude: -46.50397100000583, name: 'Ecoponto - Vila Barros' },
  ];
    ...
    return (
      ...
      >
        ...
        <View style={styles.containertitulo}>
          <Text style={styles.titulo}>Ecoponto - Vila Barros</Text>
        </View>

        <View style={styles.imagemcontainer}>
        <Image source={require('../assets/pontos/vilabarros.png')} style={styles.imagem} />
        </View>
        ...
        <Text>
          ...
          {' '}
          <Text style={styles.endereco}> Rua Guilherme Lino dos Santos, 349 </Text>
        </Text>
        </View>
...
export default VilaBarrosScreen;