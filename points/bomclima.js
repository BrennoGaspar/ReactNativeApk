...
function BomClimaScreen({ navigation }) {
  ...
  const savedCoordinates = [
    { latitude: -23.454077539421622, longitude: -46.51333923714871, name: 'Ecoponto - Bom Clima' },
  ];
    ...
    return (
      ...
      >
        ...
        <View style={styles.containertitulo}>
          <Text style={styles.titulo}>Ecoponto - Bom Clima</Text>
        </View>

        <View style={styles.imagemcontainer}>
        <Image source={require('../assets/pontos/bomclima.png')} style={styles.imagem} />
        </View>
        ...
        <Text>
          ...
          {' '}
          <Text style={styles.endereco}> Rua João Bernardo de Medeiros, 800 </Text>
        </Text>
        </View>
