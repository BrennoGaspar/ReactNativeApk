...
function VilaGalvãoScreen({ navigation }) {
  ...
  const savedCoordinates = [
    { latitude: -23.44809746453097, longitude: -46.56765185589724, name: 'Ecoponto - Vila Galvão' },
  ];
    ...
    return (
      ...
      >
        ...
        <View style={styles.containertitulo}>
          <Text style={styles.titulo}>Ecoponto - Vila Galvão</Text>
        </View>

        <View style={styles.imagemcontainer}>
        <Image source={require('../assets/pontos/vilagalvao.png')} style={styles.imagem} />
        </View>
        ...
        <Text>
          ...
          {' '}
          <Text style={styles.endereco}> Rua Ipiranga, 543 </Text>
        </Text>
        </View>
...
export default VilaGalvãoScreen;