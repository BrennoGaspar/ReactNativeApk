...
function VilaRioScreen({ navigation }) {
  ...
  const savedCoordinates = [
    { latitude: -23.433005549958224, longitude: -46.537593659718816, name: 'Ecoponto - Vila Rio' },
  ];
    ...
    return (
      ...
      >
        ...
        <View style={styles.containertitulo}>
          <Text style={styles.titulo}>Ecoponto - Vila Rio</Text>
        </View>

        <View style={styles.imagemcontainer}>
        <Image source={require('../assets/pontos/vilario.png')} style={styles.imagem} />
        </View>
        ...
        <Text>
          ...
          {' '}
          <Text style={styles.endereco}> Avenida Benjamin Harris Hunnicutt, 1509 </Text>
        </Text>
        </View>
