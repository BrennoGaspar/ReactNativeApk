...
function CabraliaScreen({ navigation }) {
  ...
  const savedCoordinates = [
    { latitude: -23.43459033861461, longitude: -46.51365139351749, name: 'Ecoponto - Cabrália' },
  ];
    ...
    return (
      ...
      >
        ...
        <View style={styles.containertitulo}>
          <Text style={styles.titulo}>Ecoponto - Cabrália</Text>
        </View>

        <View style={styles.imagemcontainer}>
        <Image source={require('../assets/pontos/cabralia.png')} style={styles.imagem} />
        </View>
        ...
        <Text>
          ...
          {' '}
          <Text style={styles.endereco}> Rua Cabrália, 100 </Text>
        </Text>
        </View>
