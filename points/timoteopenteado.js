...
function TimoteoPenteadoScreen({ navigation }) {
  ...
  const savedCoordinates = [
    { latitude: -23.462931349151273, longitude: -46.56812775256899, name: 'Ecoponto - Timóteo Penteado' },
  ];
    ...
    return (
      ...
      >
        ...
        <View style={styles.containertitulo}>
          <Text style={styles.titulo}>Ecoponto - Timóteo Penteado</Text>
        </View>

        <View style={styles.imagemcontainer}>
        <Image source={require('../assets/pontos/timoteopenteado.png')} style={styles.imagem} />
        </View>
        ...
        <Text>
          ...
          {' '}
          <Text style={styles.endereco}> Avenida Faustino Ramalho, 977   </Text>
        </Text>
        </View>
...
export default TimoteoPenteadoScreen;