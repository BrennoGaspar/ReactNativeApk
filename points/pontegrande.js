...
function PonteGrandeScreen({ navigation }) {
  ...
  const savedCoordinates = [
    { latitude: -23.508233042041653, longitude: -46.55596585766167, name: 'Ecoponto - Ponte Grande' },
  ];
    ...
    return (
      ...
      >
        ...
        <View style={styles.containertitulo}>
          <Text style={styles.titulo}>Ecoponto - Ponte Grande</Text>
        </View>

        <View style={styles.imagemcontainer}>
        <Image source={require('../assets/pontos/pontegrande.png')} style={styles.imagem} />
        </View>
        ...
        <Text>
          ...
          {' '}
          <Text style={styles.endereco}> Alameda Josefina L. Zamataro, 233 </Text>
        </Text>
        </View>
...
export default PonteGrandeScreen;