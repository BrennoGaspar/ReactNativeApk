...
function GopouvaScreen({ navigation }) {
  ...
  const savedCoordinates = [
    { latitude: -23.469533127118552, longitude: -46.53904119997559, name: 'Ecoponto - Gopoúva' },
  ];
    ...
    return (
      ...
      >
        ...
        <View style={styles.containertitulo}>
          <Text style={styles.titulo}>Ecoponto - Gopoúva</Text>
        </View>

        <View style={styles.imagemcontainer}>
        <Image source={require('../assets/pontos/gopouva.png')} style={styles.imagem} />
        </View>
        ...
        <Text>
          ...
          {' '}
          <Text style={styles.endereco}> R. Nadir, 34 </Text>
        </Text>
        </View>
        ...
        <Text>
          ...
          {' '}
          <Text style={styles.contato}>(11)2488-7200</Text>
        </Text>
        </View>
