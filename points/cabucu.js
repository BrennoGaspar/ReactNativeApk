...
function CabuçuScreen({ navigation }) {
  ...
  const savedCoordinates = [
    { latitude: -23.404052565062223, longitude: -46.53621613619393, name: 'Ecoponto - Cabuçu' },
  ];
    ...
    return (
      ...
      >
        ...
        <View style={styles.containertitulo}>
          <Text style={styles.titulo}>Ecoponto - Cabuçu</Text>
        </View>

        <View style={styles.imagemcontainer}>
        <Image source={require('../assets/pontos/cabucu.png')} style={styles.imagem} />
        </View>
        ...
        <Text>
          ...
          {' '}
          <Text style={styles.endereco}> Avenida Pedro de Souza Lopes, 7800 </Text>
        </Text>
        </View>
