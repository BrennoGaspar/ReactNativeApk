...
function MacedoScreen({ navigation }) {
  ...
  const savedCoordinates = [
    { latitude: -23.470952232507297, longitude: -46.520823730652616, name: 'Ecoponto - Macedo' },
  ];
    ...
    return (
      ...
      >
        ...
        <View style={styles.containertitulo}>
          <Text style={styles.titulo}>Ecoponto - Macedo</Text>
        </View>

        <View style={styles.imagemcontainer}>
        <Image source={require('../assets/pontos/macedo.png')} style={styles.imagem} />
        </View>
        ...
        <Text>
          ...
          {' '}
          <Text style={styles.endereco}> Rua Soldado Estanislau Wojcik, 26 </Text>
        </Text>
        </View>
